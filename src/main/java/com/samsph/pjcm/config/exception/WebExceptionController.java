...
/**
 * 全局异常处理器
 * 1. 继承AbstractErrorController，实现对basic-error-controller的覆盖
 * 2. ControllerAdvice注解监听所有的Controller，一旦抛出CustomException，就会在@ExceptionHandler(CustomException.class)对该异常进行处理。
 *
 * @author hujiahao
 */
