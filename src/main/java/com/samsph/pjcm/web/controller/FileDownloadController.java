...
public class FileDownloadController {
    ...
    public void FileDownload(@NotNull(message = "type不能为空")@Min (value = 1,message = "类型最小值为1")@Max (value = 2,message = "类型最大值为2")@PathVariable(value = "type") Integer type,
                             @NotNull(message = "id不能为空")@Min (value = 1,message = "文件id必须是正整数")@PathVariable(value = "id") Integer id,
        ...
        switch(type){
            ...
            case 2://资料
                ...
                break;
            default:
                throw new CustomException(CustomExceptionType.USER_INPUT_ERROR,"文件类型无效！！！");
        }
    }
